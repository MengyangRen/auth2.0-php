...
<xsl:template match="/doc">
	...
	<head>
		...
		<link rel="stylesheet" href="/css/wsdl/doc.css" type="text/css" ></link>
	</head>
	<body>
	<div id="main">
	<div id="mainheader">
		...
		<xsl:if test="class != '' and not(fault)">
			...
			<xsl:for-each select="class/properties/*">
				...
				<xsl:choose>
					...
					<xsl:otherwise>
						<div class='warning'><img src='/img/wsdl/warning.gif'/> missing type info</div><br />
					</xsl:otherwise>
				</xsl:choose>
			...
			<xsl:for-each select="class/methods/*">
				...
				<xsl:choose>
					...
					<xsl:otherwise>
						<div class='warning'><img src='/img/wsdl/warning.gif'/> missing return value</div><br />
					</xsl:otherwise>
				</xsl:choose>
				<xsl:choose>
	...
	<div id="mainfooter"><img src="/img/wsdl/backbottom.jpg" /></div>
	</div>
	</body>
	</html>
</xsl:template>
